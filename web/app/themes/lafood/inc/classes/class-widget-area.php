...
if ( ! class_exists( 'Lafood_Widget_Area' ) ) {

	/**
	 * Class Lafood_Widget_Area.
	 */
	class Lafood_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'lafood_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'lafood_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'lafood_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function lafood_widget_area() {
		return Lafood_Widget_Area::get_instance();
	}
