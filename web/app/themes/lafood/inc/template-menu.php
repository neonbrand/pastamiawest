 ...
 * @return string
 */
function lafood_get_main_menu() {
	$args = apply_filters( 'lafood_main_menu_args', array(
		'theme_location'   => 'main',
		'container'        => '',
		'menu_id'          => 'main-menu',
		'echo'             => false,
		'fallback_cb'      => 'lafood_set_nav_menu',
		'fallback_message' => esc_html__( 'Set main menu', 'lafood' ),
	) );
 ...
 * @return void
 */
function lafood_main_menu() {

	$main_menu = lafood_get_main_menu();
 ...
 * @return void
 */
function lafood_vertical_main_menu( $slide = 'left', $args = array() ) {

	$default_args = apply_filters( 'lafood_vertical_menu_args', array(
		...
		'button-back-inner-html'  => '<i class="linearicon linearicon-chevron-left"></i><span class="navigation-button__text">' . esc_html__( 'Back', 'lafood' ) . '</span>',
		'button-close-inner-html' => '<i class="linearicon linearicon-cross"></i>',
	) );

	$args        = wp_parse_args( $args, $default_args );
	$menu        = lafood_get_main_menu();
 ...
 * @return void
 */
function lafood_footer_menu() {
	if ( ! get_theme_mod( 'footer_menu_visibility', lafood_theme()->customizer->get_default( 'footer_menu_visibility' ) ) ) {
		return;
	}

	$args = apply_filters( 'lafood_footer_menu_args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'lafood_set_nav_menu',
		'fallback_message' => esc_html__( 'Set footer menu', 'lafood' ),
	) );
 ...
 * @return void
 */
function lafood_top_menu() {
	
	if ( ! get_theme_mod( 'top_menu_visibility', lafood_theme()->customizer->get_default( 'top_menu_visibility' ) ) ) {
		return;
	}
	...
	wp_nav_menu( apply_filters( 'lafood_top_menu_args', array(
		'theme_location'  => 'top',
		'container'       => 'div',
 ...
 * @return string
 */
function lafood_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'lafood_social_list_args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'lafood_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'lafood' ),
	), $context, $type );
 ...
 * @return null|string
 */
function lafood_set_nav_menu( $args ) {
 ...
 * @return void
 */
function lafood_menu_toggle( $menu_id ) {
	$format = apply_filters(
		'lafood_menu_toggle_html',
 ...
 * @return void
 */
function lafood_vertical_menu_toggle( $menu_id ) {
	$format = apply_filters(
		'lafood_vertical_menu_toggle_html',
