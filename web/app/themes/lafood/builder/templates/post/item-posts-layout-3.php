...
<div class="<?php echo tm_builder_tools()->get_col_classes( $this ); ?>">
	<div class="tm-posts_item">
		...
		<div class="tm-posts_item_content invert"><?php
			...
			tm_builder_core()->utility()->attributes->get_title( apply_filters( 'lafood_module_post_title_settings_layout_3', array(
				'visible'      => true,
				'trimmed_type' => 'word',
				'length'       => 5,
				'ending'       => '&hellip;',
			...
			tm_builder_core()->utility()->attributes->get_button( apply_filters( 'lafood_module_post_btn_settings_layout_3', array(
				'visible' => false,
				'text'    => esc_html__( 'Read More', 'lafood' ),
