...
if ( ! empty( $related_items ) ) {
	...
	<div class="mprm-related-items">
		<h5 class="mprm-title"><?php esc_html_e( 'You might also like', 'lafood' ); ?></h5>
			...
			<?php foreach ( $related_items as $related_item ): ?>
				<li class="mprm-related-item">
					<?php if ( has_post_thumbnail( $related_item ) ):
						echo get_the_post_thumbnail( $related_item, apply_filters( 'mprm-related-item-image-size', 'lafood-thumb-133-100' ) );
					endif; ?>
