...
<div class="<?php echo tm_builder_tools()->get_col_classes( $this ); ?>">
	<div class="tm-posts_item">
		<div class="tm-posts_item_content_wrap">
			...
			tm_builder_core()->utility()->attributes->get_title( apply_filters( 'lafood_module_post_title_settings_layout_1', array(
				'visible'      => true,
				'trimmed_type' => 'word',
				'ending'       => '&hellip;',
		...
		<div class="posts_item_content_footer">
			<?php
			tm_builder_core()->utility()->attributes->get_button( apply_filters( 'lafood_module_post_btn_settings_layout_1', array(
				'visible' => true,
