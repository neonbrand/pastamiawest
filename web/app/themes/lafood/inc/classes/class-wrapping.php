 ...
 */
add_filter( 'template_include', array( 'Lafood_Wrapping', 'wrap' ), 99 );
add_filter( 'lafood_wrap_base', 'lafood_wrap_base_cpts' );
 ...
 */
function lafood_template_path() {
	return Lafood_Wrapping::$main_template;
}
 ...
 */
function lafood_template_base() {
	return Lafood_Wrapping::$base;
}

if ( ! class_exists( 'Lafood_Wrapping' ) ) {
	...
	class Lafood_Wrapping {
		...
		/**
		 * Initialize new instance of Lafood_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'lafood_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Lafood_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function lafood_wrap_base_cpts( $templates ) {
