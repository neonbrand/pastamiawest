...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'posts-list__item card' ); ?>>
	...
	<footer class="entry-footer">
		<?php $btn_text = get_theme_mod( 'blog_read_more_text', lafood_theme()->customizer->get_default( 'blog_read_more_text' ) );
		$btn_text       = $btn_text ? $btn_text : esc_html__( 'Read more', 'lafood' );
