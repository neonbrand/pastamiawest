...
if ( ! class_exists( 'Lafood_Banner_Widget' ) ) {

	/**
	 * Class Lafood_Banner_Widget.
	 */
	class Lafood_Banner_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Display a banner in your sidebar.', 'lafood' );
			$this->widget_id          = 'lafood_widget_banner';
			$this->widget_name        = esc_html__( 'Banner', 'lafood' );
			$this->settings           = array(
				'title'  => array(
					'type'  => 'text',
					'value' => '',
				...
				'media_id' => array(
					...
					'value'              => '',
					'label'              => esc_html__( 'Source:', 'lafood' ),
				),
				'media_size' => array(
					'type'             => 'select',
					'value'            => 'full',
					...
					'options'          => false,
					'label'            => esc_html__( 'Select image size', 'lafood' ),
					'placeholder'      => esc_html__( 'Select image size', 'lafood' ),
				),
				'link' => array(
					'type'        => 'text',
					'placeholder' => esc_html__( 'Type a banner`s link', 'lafood' ),
					'value'       => esc_url( home_url( '/' ) ),
					'label'       => esc_html__( 'Link:', 'lafood' ),
				),
				'target' => array(
					'type'    => 'select',
					'options' => array(
						'_blank' => esc_html__( 'A new window or tab', 'lafood' ),
						'_self'  => esc_html__( 'The same frame as it was clicked', 'lafood' ),
					),
					'value' => '_blank',
					'label' => esc_html__( 'Opens in:', 'lafood' ),
				),
			);
		...
		public function get_image_sizes() {
			...
			$result = array_merge( $result, array( 'full' => esc_html__( 'Full', 'lafood' ) ) );
...
add_action( 'widgets_init', 'lafood_register_banner_widget' );
/**
 * Register banner widget.
 */
function lafood_register_banner_widget() {
	register_widget( 'Lafood_Banner_Widget' );
}
