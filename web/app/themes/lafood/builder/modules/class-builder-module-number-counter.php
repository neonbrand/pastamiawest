<?php
/**
 * Class Lafood_Builder_Module_Number_Counter.
 */
class Lafood_Builder_Module_Number_Counter extends Tm_Builder_Module {

	public $function_name;

	public function init() {
		$this->name = esc_html__( 'Number Counter', 'lafood' );
		...
		$this->custom_css_options = array(
			'percent' => array(
				'label'    => esc_html__( 'Percent', 'lafood' ),
				'selector' => '.percent',
			),
			'number_counter_title' => array(
				'label'    => esc_html__( 'Number Counter Title', 'lafood' ),
				'selector' => 'h3',
			),
		);
		...
		$this->advanced_options = array(
			'fonts' => array(
				...
				'number'   => array(
					'label'    => esc_html__( 'Number', 'lafood' ),
					'css'      => array(
	...
	public function get_fields() {
		$fields = array(
			'title' => array(
				...
				'description'     => esc_html__( 'Input a title for the counter.', 'lafood' ),
			),
			'number' => array(
				'label'           => esc_html__( 'Number', 'lafood' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( "Define a number for the counter. (Don't include the percentage sign, use the option below.)", 'lafood' ),
			),
			'percent_sign' => array(
				'label'           => esc_html__( 'Percent Sign', 'lafood' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'on'  => esc_html__( 'On', 'lafood' ),
					'off' => esc_html__( 'Off', 'lafood' ),
				),
				'description'     => esc_html__( 'Here you can choose whether the percent sign should be added after the number set above.', 'lafood' ),
			),
			'counter_color' => array(
				'label'       => esc_html__( 'Counter Text Color', 'lafood' ),
				'type'        => 'color',
				'description' => esc_html__( 'This will change the fill color for the bar.', 'lafood' ),
			),
			'use_icon' => array(
				'label'           => esc_html__( 'Use Icon', 'lafood' ),
				'type'            => 'yes_no_button',
				'option_category' => 'basic_option',
				'options'         => array(
				...
				'description'     => esc_html__( 'Here you can choose whether icon set below should be used.', 'lafood' ),
			),
			'font_icon' => array(
...
new Lafood_Builder_Module_Number_Counter;
