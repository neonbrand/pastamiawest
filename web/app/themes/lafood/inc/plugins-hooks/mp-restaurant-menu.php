...
add_action( 'mprm_shortcode_menu_item_grid', 'lafood_mprm_menu_item_image_before', 20 );
...
add_action( 'mprm_shortcode_menu_item_grid', 'lafood_mprm_menu_item_image_after', 35 );
add_action( 'mprm_shortcode_menu_item_grid', 'lafood_mprm_menu_item_entry_header_before', 40 );
...
add_action( 'mprm_shortcode_menu_item_grid', 'lafood_mprm_menu_item_entry_header_after', 50 );
add_action( 'mprm_shortcode_menu_item_grid', 'lafood_mprm_menu_item_main_content_before', 55 );
...
add_action( 'mprm_shortcode_menu_item_grid', 'lafood_mprm_menu_item_main_content_after', 70 );
...
add_action( 'mprm_shortcode_menu_item_simple-list', 'lafood_mprm_menu_item_main_content_before', 28 );
...
add_action( 'mprm_shortcode_menu_item_simple-list', 'lafood_mprm_menu_item_main_content_after', 35 );
...
add_action( 'mprm_shortcode_menu_item_list', 'lafood_mprm_menu_item_entry_header_before', 23 );
add_action( 'mprm_shortcode_menu_item_list', 'mprm_menu_item_list_price', 28 );
add_action( 'mprm_shortcode_menu_item_list', 'lafood_mprm_menu_item_entry_header_after', 30 );
add_action( 'mprm_shortcode_menu_item_list', 'lafood_mprm_menu_item_main_content_before', 33 );
...
add_action( 'mprm_shortcode_menu_item_list', 'lafood_mprm_menu_item_main_content_after', 43 );
...
add_action( 'mprm_menu_item_content_before', 'lafood_mprm_menu_item_single_title', 10 );
add_action( 'mprm_menu_item_content_before', 'lafood_mprm_menu_item_single_image', 20 );

add_action( 'mprm_menu_item_content_after', 'lafood_mprm_menu_item_share_btns', 10 );
...
add_action( 'mprm_taxonomy_grid', 'lafood_mprm_single_category_grid_header', 10 );
add_action( 'mprm_taxonomy_grid', 'lafood_mprm_menu_item_entry_header_before', 38 );
add_action( 'mprm_taxonomy_grid', 'mprm_single_category_grid_price', 43 );
add_action( 'mprm_taxonomy_grid', 'lafood_mprm_menu_item_entry_header_after', 45 );
add_action( 'mprm_taxonomy_grid', 'lafood_mprm_menu_item_main_content_before', 47 );
add_action( 'mprm_taxonomy_grid', 'lafood_mprm_single_taxonomy_excerpt', 50 );
add_action( 'mprm_taxonomy_grid', 'lafood_mprm_single_taxonomy_attributes', 53 );
add_action( 'mprm_taxonomy_grid', 'lafood_mprm_menu_item_main_content_after', 55 );

// Enable mprm category shortcode button.
add_filter( 'lafood_mprm_category_btn_visibility', '__return_true' );

/**
 * Mprm menu-item image html-wrapper before.
 */
function lafood_mprm_menu_item_image_before() {
 ...
 */
function lafood_mprm_menu_item_image_after() {
	echo '</figure>';
}
 ...
 */
function lafood_mprm_menu_item_entry_header_before() {
 ...
 */
function lafood_mprm_menu_item_entry_header_after() {
	echo '</header>';
}
 ...
 */
function lafood_mprm_menu_item_main_content_before() {
 ...
 */
function lafood_mprm_menu_item_main_content_after() {
	echo '</div>';
}
 ...
 */
function lafood_mprm_menu_item_single_title() {
	lafood_utility()->utility->attributes->get_title( array(
		'class' => 'mprm-title',
		'html'  => '<h4 %1$s>%4$s</h4>',
		'echo'  => true,
	) );
 ...
 */
function lafood_mprm_menu_item_single_image() {
	lafood_utility()->utility->media->get_image( array(
		'size'        => 'lafood-thumb-l',
 ...
 * Print share buttons.
 */
function lafood_mprm_menu_item_share_btns() {
	lafood_share_buttons( 'single' );
}

/**
 * Taxonomy header before.
 */
function lafood_mprm_single_category_grid_header() { ?>
 ...
 * Taxonomy excerpt.
 */
function lafood_mprm_single_taxonomy_excerpt() {
	lafood_utility()->utility->attributes->get_content( array (
		'length'       => -1,
 ...
 * Taxonomy attributes.
 */
function lafood_mprm_single_taxonomy_attributes() {
