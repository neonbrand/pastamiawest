...
<div class="mprm-menu-category <?php echo get_column_class( $mprm_view_args['col'] ) ?>">
	...
	<div class="mprm-category-content <?php echo ( $image_is_available && $category_image_src ) ? 'mprm-columns mprm-seven' : '' ?>">
		...
		?>
		<?php if ( apply_filters( 'lafood_mprm_category_btn_visibility', false ) ) { ?>
			<a href="<?php echo esc_url( get_term_link( $mprm_term ) ); ?>" class="mprm-btn btn btn-primary"><?php echo apply_filters( 'lafood_mprm_category_btn_text', esc_html__( 'See menu', 'lafood' ) ) ?></a>
		<?php } ?>
