...
<div class="swiper-container" >
	...
	<div class="swiper-button-prev"><?php echo apply_filters( 'lafood_pb_carousel_module_prev_button_icon', '<i class="linearicon linearicon-chevron-left"></i>' ) ?></div>
	<div class="swiper-button-next"><?php echo apply_filters( 'lafood_pb_carousel_module_next_button_icon', '<i class="linearicon linearicon-chevron-right"></i>' ) ?></div>
</div>
