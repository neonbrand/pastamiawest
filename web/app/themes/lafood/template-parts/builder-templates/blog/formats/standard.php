...
<div class="tm_pb_content_container">
	<?php if ( 'list' === $module->_var( 'blog_layout' ) ) {
			lafood_get_builder_module_template( 'blog/meta.php', $module );
	} ?>
	...
	<?php
	$title_html = ( 'list' !== $module->_var( 'blog_layout' ) ) ? '<h4 %1$s><a href="%2$s" %3$s rel="bookmark">%4$s</a></h4>' : '<h4 %1$s><a href="%2$s" %3$s rel="bookmark">%4$s</a></h4>';
