 ...
 * @package Lafood
 */
if ( ! class_exists( 'Lafood_Image_Grid_Widget' ) ) {

	/**
	 * Image Grid Widget
	 */
	class Lafood_Image_Grid_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			$this->widget_name        = esc_html__( 'Image Grid', 'lafood' );
			$this->widget_description = esc_html__( 'This widget displays images from post.', 'lafood' );
			...
			$this->settings           = array(
				'title' => array(
					'type'  => 'text',
					'value' => 'Image Grid',
					'label' => esc_html__( 'Widget title', 'lafood' ),
				),
				'terms_type' => array(
					'type'    => 'radio',
					'value'   => 'category_name',
				...
				'category_name' => array(
					...
					'label'            => esc_html__( 'Select categories to show', 'lafood' ),
				...
				'tag' => array(
					...
					'label'            => esc_html__( 'Select tags to show', 'lafood' ),
				...
				'post_sort' => array(
					...
					'value'   => 'date',
					'options' => array(
						'date'          => esc_html__( 'Publish Date', 'lafood' ),
						'title'         => esc_html__( 'Post Title', 'lafood' ),
						'comment_count' => esc_html__( 'Comment Count', 'lafood' ),
					),
					'label'   => esc_html__( 'Post sorted', 'lafood' ),
				),
				'post_number' => array(
					'type'       => 'stepper',
					'value'      => '5',
					...
					'min_value'  => '1',
					'step_value' => '1',
					'label'      => esc_html__( 'Posts number', 'lafood' ),
				),
				'post_offset' => array(
					'type'       => 'stepper',
					'value'      => '0',
				...
				'columns_number' => array(
					...
					'min_value'  => '1',
					'step_value' => '1',
					'label'      => esc_html__( 'Columns number', 'lafood' ),
				),
				'items_padding' => array(
					'type'       => 'stepper',
					'value'      => '5',
					...
					'min_value'  => '0',
					'step_value' => '1',
					'label'      => esc_html__( 'Items padding ( size in pixels )', 'lafood' ),
				),
			);
		...
		public function widget( $args, $instance ) {
			...
			$args = apply_filters( 'lafood_image_grid_widget_args', $args, $instance );
			...
			if ( array_key_exists( $terms_type, $instance ) ) {
				...
				if ( $post_taxonomy ) {
					$post_args = array(
						...
						'order'       => apply_filters( 'lafood_order_image_grid_widget', 'DESC', $instance ), // ASC
			...
			if ( isset( $posts ) && $posts ) {
				...
				$grid_class_array = apply_filters( 'lafood_image_grid_widget_grid_class', array(
				...
				echo apply_filters(
					'lafood_image_grid_widget_before',
				...
				echo apply_filters( 'lafood_image_grid_widget_after', '</div>', $instance );
			}
	...
	add_action( 'widgets_init', 'lafood_register_image_grid_widget' );
	/**
	 * Register image grid widget.
	 */
	function lafood_register_image_grid_widget() {
		register_widget( 'Lafood_Image_Grid_Widget' );
	}
}
