...
if ( ! class_exists( 'Lafood_Smart_Slider_Widget' ) ) {

	/**
	 * Class Lafood_Smart_Slider_Widget.
	 */
	class Lafood_Smart_Slider_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Display smart slider on your site.', 'lafood' );
			$this->widget_id          = 'lafood_widget_smart_slider';
			$this->widget_name        = esc_html__( 'Smart Slider', 'lafood' );
			$this->utility            = lafood_utility()->utility;
			$this->settings           = array(
				'title' => array(
					'type'  => 'text',
					'value' => '',
				...
				'terms_type' => array(
					...
					'options' => array(
						'category' => array(
							'label' => esc_html__( 'Category', 'lafood' ),
							'slave' => 'terms_type_category',
						),
						'post_tag' => array(
							'label' => esc_html__( 'Tag', 'lafood' ),
							'slave' => 'terms_type_post_tag',
						),
					),
					'label'   => esc_html__( 'Choose taxonomy type', 'lafood' ),
				),
				'categories' => array(
					'type'             => 'select',
					'size'             => 1,
					...
					'options'          => false,
					'label'            => esc_html__( 'Select category', 'lafood' ),
					'multiple'         => true,
					'placeholder'      => esc_html__( 'Select category', 'lafood' ),
				...
				'tags' => array(
					...
					'options'          => false,
					'label'            => esc_html__( 'Select tags', 'lafood' ),
					'multiple'         => true,
					'placeholder'      => esc_html__( 'Select tags', 'lafood' ),
				...
				'posts_per_page' => array(
					...
					'max_value' => 50,
					'min_value' => 1,
					'label'     => esc_html__( 'Posts count', 'lafood' ),
				),
				'post_title' => array(
					'type'  => 'switcher',
					'value' => 'true',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Display title', 'lafood' ),
				),
				'content' => array(
					'type'  => 'switcher',
					'value' => 'false',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Display content', 'lafood' ),
				),
				'more_button' => array(
					'type'   => 'switcher',
					'value'  => 'true',
					'style'  => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'  => esc_html__( 'Display more button', 'lafood' ),
					'toggle' => array(
						'true_toggle'  => esc_html__( 'On', 'lafood' ),
						'false_toggle' => esc_html__( 'Off', 'lafood' ),
				...
				'more_button_text' => array(
					'type'   => 'text',
					'value'  => esc_html__( 'Read more', 'lafood' ),
					'label'  => esc_html__( 'More button text', 'lafood' ),
				...
				'title_trim_words' => array(
					...
					'min_value'  => 1,
					'step_value' => 1,
					'label'      => esc_html__( 'Title words trimmed count', 'lafood' ),
				),
				'trim_words' => array(
					'type'       => 'slider',
					'value'      => 15,
					...
					'min_value'  => 1,
					'step_value' => 1,
					'label'      => esc_html__( 'Content words trimmed count', 'lafood' ),
				),
				'width' => array(
					'type'  => 'text',
					'value' => '100%',
					'label' => esc_html__( 'Slider width', 'lafood' ),
				),
				'height' => array(
					'type'  => 'text',
					'value' => '800',
					'label' => esc_html__( 'Slider height', 'lafood' ),
				),
				'orientation' => array(
					'type'    => 'select',
					'size'    => 1,
					'value'   => 'horizontal',
					'options' => array(
						'horizontal' => esc_html__( 'Horizontal', 'lafood' ),
						'vertical'   => esc_html__( 'Vertical', 'lafood' ),
					),
					'label'   => esc_html__( 'Slider orientation', 'lafood' ),
				),
				'slide_distance' => array(
					...
					'max_value' => 100,
					'min_value' => 0,
					'label'     => esc_html__( 'Slide distance(px)', 'lafood' ),
				),
				'slide_duration' => array(
					...
					'min_value'  => 100,
					'step_value' => 100,
					'label'      => esc_html__( 'Slide duration(ms)', 'lafood' ),
				),
				'slide_fade' => array(
					'type'  => 'switcher',
					'value' => 'false',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Use fade effect?', 'lafood' ),
				),
				'navigation' => array(
					'type'   => 'switcher',
					'value'  => 'true',
					'style'  => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'  => esc_html__( 'Use navigation?', 'lafood' ),
					'toggle' => array(
						'true_toggle'  => esc_html__( 'On', 'lafood' ),
						'false_toggle' => esc_html__( 'Off', 'lafood' ),
				...
				'fade_navigation' => array(
					...
					'value'  => 'true',
					'style'  => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'  => esc_html__( 'Indicates whether the arrows will fade in only on hover', 'lafood' ),
				...
				'pagination' => array(
					...
					'value' => 'true',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Use pagination?', 'lafood' ),
				),
				'autoplay' => array(
					'type'  => 'switcher',
					'value' => 'true',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Use autoplay?', 'lafood' ),
				),
				'fullScreen' => array(
					'type'  => 'switcher',
					'value' => 'false',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Display fullScreen button?', 'lafood' ),
				),
				'shuffle' => array(
					'type'  => 'switcher',
					'value' => 'false',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Indicates if the slides will be shuffled', 'lafood' ),
				),
				'loop' => array(
					'type'  => 'switcher',
					'value' => 'true',
					'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label' => esc_html__( 'Use infinite scrolling?', 'lafood' ),
				),
				'thumbnails' => array(
					'type'   => 'switcher',
					'value'  => 'false',
					'style'  => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'  => esc_html__( 'Display thumbnails?', 'lafood' ),
					'toggle' => array(
						'true_toggle'  => esc_html__( 'On', 'lafood' ),
						'false_toggle' => esc_html__( 'Off', 'lafood' ),
				...
				'thumbnails_position' => array(
					...
					'options' => array(
						...
						'bottom' => esc_html__( 'Bottom', 'lafood' ),
						'right'  => esc_html__( 'Right', 'lafood' ),
						'left'   => esc_html__( 'Left', 'lafood' ),
					),
					'label'   => esc_html__( 'Sets the position of the thumbnail scroller', 'lafood' ),
				...
				'thumbnails_arrows' => array(
					...
					'value'  => 'true',
					'style'  => ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'  => esc_html__( 'Display thumbnails arrows?', 'lafood' ),
					'master' => 'thumbnails_attr',
				),
			);
		...
		public function widget( $args, $instance ) {
			...
			if ( $posts_query ) {
				...
				$html = '<h4>' . esc_html__( 'Posts for slider not found', 'lafood' ) . '</h4>';
			}
		...
		public function render_slider( $posts_query ) {
			...
			$html = '<div class="lafood-smartslider smart-slider__instance invert" ' . $slider_html_attr . '>';
		...
		public function get_query_slider_items( $query_args = array() ) {
			...
			$defaults_query_args = apply_filters( 'lafood_smart_slider_default_query_args', array(
				'post_type'           => 'post',
				'orderby'             => 'date',
				'order'               => 'DESC',
				'posts_per_page'      => - 1,
		...
		public function get_slider_loop( $posts_query ) {
			 ...
			 * @var  array
			 */
			$title_settings = apply_filters( 'lafood_smart_slider_title_settings', array(
				'width'           => '100%%',
				'horizontal'      => '0%%',
				'vertical'        => '38%%',
			 ...
			 * @var  array
			 */
			$content_settings = apply_filters( 'lafood_smart_slider_content_settings', array(
				'width'           => '100%%',
				'horizontal'      => '5%%',
				'vertical'        => '51%%',
				'show_transition' => 'left',
			 ...
			 * @var  array
			 */
			$more_settings = apply_filters( 'lafood_smart_slider_more_button_settings', array(
				'width'           => '100%%',
				'horizontal'      => '5%%',
				'vertical'        => '58%%',
				'show_transition' => 'left',
		...
		public function get_slider_thumbnails( $posts_query ) {
			...
			while ( $posts_query->have_posts() ) : $posts_query->the_post();
				$html .= '<div class="sp-thumbnail">';
					$html .= $this->utility->media->get_image( array(
						'size'        => 'lafood-slider-thumb',
						'mobile_size' => 'lafood-slider-thumb',
	...
	add_action( 'widgets_init', 'lafood_register_smart_slider_widgets' );
	/**
	 * Register Smart slider widget.
	 */
	function lafood_register_smart_slider_widgets() {
		register_widget( 'Lafood_Smart_Slider_Widget' );
	}
}
