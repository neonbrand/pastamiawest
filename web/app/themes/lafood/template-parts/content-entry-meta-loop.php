...
<?php if ( 'post' === get_post_type() ) : ?>
	...
	<div class="entry-meta">
		...
		<?php $date_visible = lafood_is_meta_visible( 'blog_post_publish_date', 'loop' );
		...
		<?php $author_visible = lafood_is_meta_visible( 'blog_post_author', 'loop' );
		...
		<?php $comment_visible = lafood_is_meta_visible( 'blog_post_comments', 'loop' );
		...
		<?php $tags_visible = lafood_is_meta_visible( 'blog_post_tags', 'loop' );
